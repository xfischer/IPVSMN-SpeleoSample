...
namespace WpfSampleApp
{
    public class DemNetVisualTopoService
    {
        ...
        public DemNetVisualTopoService(VisualTopoService visualTopoService,
                                        ElevationService elevationService,
                                        SharpGltfService sharpGltfService,
                                        MeshService meshService,
                                        ImageryService imageryService)
        {
            this.visualTopoService = visualTopoService;
        ...
        internal ModelRoot GenerateVisualTopoGltfModel(VisualTopoModel visualTopoModel, DEMDataSet dataset, string outputFile, bool drawOnTexture, float marginMeters, float zFactor, ImageryProvider imageryProvider)
        {
            int outputSrid = 3857;
        ...
        internal void ExportVisualTopoToGLB(VisualTopoModel visualTopoModel, DEMDataSet dataset, string outputFile, bool drawOnTexture, float marginMeters, float zFactor, ImageryProvider imageryProvider)
        {
            ...
            var gltfModel = GenerateVisualTopoGltfModel(visualTopoModel, dataset, outputFile, drawOnTexture, marginMeters, zFactor, imageryProvider);
